...
describe("message", () => {
  it("should contain a custom message", () => {
    ...
    return validator.validate(model).then((errors) => {
      ...
      expect(errors[0].constraints).toEqual({
        contains: "String is not valid. You string must contain a hello word",
      });
    });
  });
  ...
  it("$value token should be replaced in a custom message", () => {
    ...
    return validator.validate(model).then((errors) => {
      ...
      expect(errors[0].constraints).toEqual({
        contains:
          "hell no world is not valid. You string must contain a hello word",
      });
    });
  });
  ...
  it("$value token should be replaced in a custom message", () => {
    ...
    return validator.validate(model).then((errors) => {
      expect(errors.length).toEqual(1);
      expect(errors[0].constraints).toEqual({
        minLength: " is too short, minimum length is 2 characters name",
      });
    });
  });
  ...
  describe("validation options", function () {
    describe("message", function () {
      it("should contain a custom message", function () {
        class MyClass {
          @Contains("hello", {
            message:
              "String is not valid. You string must contain a hello word",
          })
          someProperty: string;
        }
      ...
      it("$value token should be replaced in a custom message", function () {
        class MyClass {
          @Contains("hello", {
            message:
              "$value is not valid. You string must contain a hello word",
          })
          someProperty: string;
        }
      ...
      it("$constraint1 token should be replaced in a custom message", function () {
        class MyClass {
          @Contains("hello", {
            message:
              "String is not valid. You string must contain a $constraint1 word",
          })
          someProperty: string;
        }
      ...
      it("$property token should be replaced in a custom message", function () {
        ...
        return validator.validate(model).then((errors) => {
          errors.length.should.be.equal(1);
          errors[0].constraints.should.be.eql({
            contains: "someProperty is not valid.",
          });
        });
      });
      ...
      it("should replace all token", function () {
        class MyClass {
          @Contains("hello", {
            message:
              "$target#$property is not valid: $value must contain a $constraint1 word",
          })
          someProperty: string;
        }
        ...
        return validator.validate(model).then((errors) => {
          ...
          errors[0].constraints.should.be.eql({
            contains:
              "MyClass#someProperty is not valid: hell no world must contain a hello word",
          });
        });
      });
    });
    ...
    describe("each", function () {
      describe("Array", function () {
        it("should apply validation to each item in the array", function () {
          ...
          return validator.validate(model).then((errors) => {
            ...
            errors[0].constraints.should.be.eql({
              contains:
                "each value in someProperty must contain a hello string",
            });
        ...
        it("should apply validation via custom constraint class to array items (but not array itself)", function () {
          ...
          class CustomIsNotArrayConstraint
          ...
          const model = new MyClass();
          model.someArrayOfNonArrayItems = [
            "not array",
            "also not array",
            "not array at all",
          ];
        ...
        it("should apply validation via custom constraint class with synchronous logic to each item in the array", function () {
          @ValidatorConstraint({
            name: "customContainsHelloConstraint",
            async: false,
          })
          class CustomContainsHelloConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
              return (
                !(value instanceof Array) && String(value).includes("hello")
              );
            }
          }
        ...
        it("should apply validation via custom constraint class with async logic to each item in the array", function () {
          @ValidatorConstraint({
            name: "customAsyncContainsHelloConstraint",
            async: true,
          })
          class CustomAsyncContainsHelloConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
              const isValid = !(value instanceof Array) &&
                String(value).includes("hello");
        ...
        it("should apply validation via custom constraint class with mixed (synchronous + async) logic to each item in the array", function () {
          @ValidatorConstraint({
            name: "customMixedContainsHelloConstraint",
            async: true,
          })
          class CustomMixedContainsHelloConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
              const isValid = !(value instanceof Array) &&
                String(value).includes("hello");
      ...
      describe("Set", function () {
        ...
        it("should apply validation via custom constraint class to Set items (but not Set itself)", function () {
          @ValidatorConstraint({
            name: "customIsNotSetConstraint",
            async: false,
          })
          class CustomIsNotSetConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
          ...
          const model = new MyClass();
          model.someSetOfNonSetItems = new Set<string>([
            "not array",
            "also not array",
            "not array at all",
          ]);
        ...
        it("should apply validation via custom constraint class with async logic to each item in the Set", function () {
          ...
          class CustomAsyncContainsHelloConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
              const isValid = !(value instanceof Set) &&
                String(value).includes("hello");
      ...
      describe("Map", function () {
        ...
        it("should apply validation via custom constraint class to Map items (but not Map itself)", function () {
          @ValidatorConstraint({
            name: "customIsNotMapConstraint",
            async: false,
          })
          class CustomIsNotMapConstraint
            implements ValidatorConstraintInterface {
            validate(value: any) {
    ...
    describe("groups", function () {
      ...
      function expectTextContains(error: ValidationError) {
        error.constraints.should.eql({
          contains: "text must contain a bye string",
        });
      }
      ...
      describe("should validate only properties of the given group: title-validation", function () {
        it("with valid title", function () {
          return validator
            .validate(validTitle, { groups: ["title-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(0);
            });
        });
        ...
        it("with valid text", function () {
          return validator
            .validate(validText, { groups: ["title-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(1);
        ...
        it("with both valid", function () {
          return validator
            .validate(validBoth, { groups: ["title-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(0);
            });
        });
        ...
        it("with none valid", function () {
          return validator
            .validate(validNone, { groups: ["title-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(1);
              expectTitleContains(errors[0]);
            });
      ...
      describe("should validate only properties of the given group: text-validation", function () {
        it("with valid title", function () {
          return validator
            .validate(validTitle, { groups: ["text-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(1);
        ...
        it("with valid text", function () {
          return validator
            .validate(validText, { groups: ["text-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(0);
            });
        });
        ...
        it("with both valid", function () {
          return validator
            .validate(validBoth, { groups: ["text-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(0);
            });
        });
        ...
        it("with none valid", function () {
          return validator
            .validate(validNone, { groups: ["text-validation"] })
            .then((errors) => {
              errors.length.should.be.equal(1);
              expectTextContains(errors[0]);
            });
      ...
      describe("should validate only properties of the given groups: both groups", function () {
        it("with valid title", function () {
          return validator
            .validate(validTitle, {
              groups: ["title-validation", "text-validation"],
            })
            .then((errors) => {
              errors.length.should.be.equal(1);
              expectTextContains(errors[0]);
      ...
      describe("multiple groups per property", function () {
        ...
        describe("group: contains", function () {
          it("with valid contains", function () {
            return validator
              .validate(validContains, { groups: ["contains"] })
              .then((errors) => {
                errors.length.should.be.equal(0);
              });
          });
          ...
          it("with valid matches", function () {
            return validator
              .validate(validMatches, { groups: ["contains"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                expectTitleContains(errors[0]);
              });
          ...
          it("with valid both", function () {
            return validator
              .validate(validBoth, { groups: ["contains"] })
              .then((errors) => {
                errors.length.should.be.equal(0);
              });
          });
          ...
          it("with valid none", function () {
            return validator
              .validate(validNone, { groups: ["contains"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                expectTitleContains(errors[0]);
              });
        ...
        describe("group: matches", function () {
          it("with valid contains", function () {
            return validator
              .validate(validContains, { groups: ["matches"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
          ...
          it("with valid matches", function () {
            return validator
              .validate(validMatches, { groups: ["matches"] })
              .then((errors) => {
                errors.length.should.be.equal(0);
              });
          });
          ...
          it("with valid both", function () {
            return validator
              .validate(validBoth, { groups: ["matches"] })
              .then((errors) => {
                errors.length.should.be.equal(0);
              });
          });
          ...
          it("with valid none", function () {
            return validator
              .validate(validNone, { groups: ["matches"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                expectTitleMatches(errors[0]);
              });
        ...
        describe("groups: contains & matches", function () {
          it("with valid contains", function () {
            return validator
              .validate(validContains, { groups: ["contains", "matches"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                expectTitleMatches(errors[0]);
              });
          ...
          it("with valid matches", function () {
            return validator
              .validate(validMatches, { groups: ["contains", "matches"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                expectTitleContains(errors[0]);
              });
          ...
          it("with valid both", function () {
            return validator
              .validate(validBoth, { groups: ["contains", "matches"] })
              .then((errors) => {
                errors.length.should.be.equal(0);
              });
          });
          ...
          it("with valid none", function () {
            return validator
              .validate(validNone, { groups: ["contains", "matches"] })
              .then((errors) => {
                errors.length.should.be.equal(1);
                errors[0].constraints.should.be.eql({
                  contains: "title must contain a hello string",
      ...
      describe("always", function () {
        ...
        it("should always validate a marked field even if another group is specified", function () {
          return validator
            .validate(model, { groups: ["sometimes"] })
            .then((errors) => {
              errors.length.should.be.equal(2);
              expectTitleContains(errors[0]);
              expectTextContains(errors[1]);
        ...
        it("should always validate *all* fields if group is not specified", function () {
          return validator
            .validate(model, { groups: undefined })
            .then((errors) => {
              errors.length.should.be.equal(2);
              expectTitleContains(errors[0]);
              expectTextContains(errors[1]);
      ...
      describe("groups - nested", function () {
        ...
        function expectChildConstraint(
          ...
          error.children[0].constraints.should.eql({
